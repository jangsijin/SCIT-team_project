...
<body>
 ...
 <form action="writeDiary" enctype="multipart/form-data" method="post" onsubmit="return check();">
                            <div class="card-header" style="background: blue;">
                                <h5 class="card-title" style="height: 10px ; display: table-cell; vertical-align: middle; color: white;">오늘 한 공부</h5>
                            </div>
                            <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-11">
                                             ...
                                             <c:if test="${i.title == p.title}">
                                             <h5>${p.title} : 예정 <strong>${p.total}분</strong> 중 <strong>${i.total}분</strong> 만큼 공부했습니다.&nbsp;&nbsp;&nbsp; <br>
    	                                                                                   달성률 : <span style="color:blue;"><fmt:formatNumber value="${i.total/p.total}" type="percent"/></span></h5>
                                             </c:if>
										     </c:forEach>
										     </c:forEach>
                                        </div>
                                    ...
                                    <div class="form-group col-md-11">
                                     ...
                                     <div class="form-group col-md-11">
										  ...
										  <textarea class="form-control" name="detail" id="detail" rows="3" placeholder="내용을 적어주세요"></textarea>
                                    
                                     </div>
                                        
                                      <div class="form-group col-md-11">
										<label for="reader">이미지 첨부</label>
    									<input type="file" class="form-control" name="upload" id="reader">
                                     </div>   
                                    </div>
                                     <div>
