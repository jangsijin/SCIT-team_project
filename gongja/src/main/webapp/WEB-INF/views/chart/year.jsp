...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  ...
  <!-- 5번 차트 (연간)-->
   ...
   function drawChart() {
       ...
       dataTable.addColumn({ type: 'number', id: '공부시간' });
       dataTable.addRows(str5);
...
div.google-visualization-tooltip { width:180px; }
</style>
</head>
<body>
...
<div class="container">
<br>
<button type="button" class="btn btn-outline-primary btn-block" onclick="location.href='today'">일일통계</button>
<button type="button" class="btn btn-outline-primary btn-block" onclick="location.href='week'">주간통계</button>
<br>
<div class="row">
<div class="col">
<div align="center">
<h4><strong>[연간 공부 그래프]</strong><small>(단위 : 분)</small></h4>
