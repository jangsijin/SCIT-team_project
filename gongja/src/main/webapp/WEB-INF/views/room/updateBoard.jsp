...
function check(){
	...
	$.ajax({
		url: 'updateBoard',
		type: 'post',
		data: {num:num, title:title, detail:detail, code:code},
		dataType: 'text',
	...
	window.location.href="board?num="+${board.num}+"&room_num="+${board.room_num};
}
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea cols="50" rows="5" id="detail">${board.detail}</textarea>
                                        </div>
                                        <c:if test="${leader == 1}">
